...
const PRESETS: Array<Omit<Source, 'id' | 'createdAt'>> = [
  ...
  { type: 'profile', name: 'Goʻzallik saloni — Fargʻona', subtitle: 'MCC 7230',           context: 'Goʻzallik saloni (MCC 7230), Fargʻona.',         region_id: 'fergana-01',   mcc_code: '7230', monthly_revenue: 8_000,  initial_investment: 25_000,  selected: true },
